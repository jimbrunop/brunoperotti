...
function iniciarJogo(){
  var gameCanvas = window.document.getElementById("gameCanvas"); 
  var telaInicio = window.document.getElementById("telaInicio");
...
function final_anim_obstaculo()
{
  ...
  console.log(conta_obstaculos, "aquiTio")
...
function colisao(){
  var colidiu = window.document.getElementById("colidiu");
  console.log("colisao()");
  perde_energia(10);

  colidiu.style.display = "block"; 

  setTimeout(function(){
    colidiu.style.display = "none";
  }, 1000);
...
function verifica_mudanca_de_fase()
{
  ...
  if (conta_obstaculos >= nobstaculos){
    var imgdiv = document.getElementById("plano2");
    var secondRound = document.getElementById("secondRound");

    imgdiv.style.backgroundImage = "url(/images/teste.jpg)";
...
function perde_energia(decremento) {
  ...
  var vidaBarraGanha = window.document.getElementById('energiaVida');


  if (energia <= 90) {

    vidaBarraGanha.style.width = "260px";
  };

  if (energia <= 80) {
    vidaBarraGanha.style.width = "220px";
  };

  if (energia <= 80) {
    vidaBarraGanha.style.width = "180px";
  };

  if (energia <= 70) {
    vidaBarraGanha.style.width = "150px";
  };

  if (energia <= 60) {
    vidaBarraGanha.style.width = "120px";
    vidaBarraGanha.style.backgroundColor="yellow";
  };

  if (energia <= 50) {
    vidaBarraGanha.style.width = "100px";
    vidaBarraGanha.style.backgroundColor="yellow";
  };

  if (energia <= 40) {
    vidaBarraGanha.style.width = "80px";
    vidaBarraGanha.style.backgroundColor="red";
  };

  if (energia <= 30) {
    vidaBarraGanha.style.width = "60px";
    vidaBarraGanha.style.backgroundColor="red";
  };

  if (energia <= 20) {
    vidaBarraGanha.style.width = "20px";
    vidaBarraGanha.style.backgroundColor="red";
  };
  ...
  // garante que energia não seja menor que 0
  if (energia < 0)
    energia = 0;
...
function finaliza_jogo(){
 ...
 var gameCanvas = window.document.getElementById("gameCanvas"); 
 var telaFinal = window.document.getElementById("telaFim");
...
function reinicio_jogo(){
  var telaFinal = window.document.getElementById("telaFim");
  var plano = window.document.getElementById("plano2");
  var vidaBarraGanha = window.document.getElementById('energiaVida');
  atualiza_display_energia();
  telaFinal.style.display = "none";


  plano.style.backgroundImage="url(images/zombi.jpg)";
  vidaBarraGanha.style.backgroundColor="rgba(0, 128, 0, 0.6)";
  vidaBarraGanha.style.width="300px";
